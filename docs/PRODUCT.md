...
- 저장되는 것: 거울 이름 / 출처 / 배경 / 그림 / 스티커 / 사진 스티커 / 텍스트 / 레이어 순서 / 보관 슬롯.
- 사진 스티커 이미지는 거울마다 복사되지 않는다. 거울을 복제해도 같은 사진 하나를 함께 본다.
